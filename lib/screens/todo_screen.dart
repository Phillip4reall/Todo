...
//           // Statistics section
//        //  TodoStats(total: null, completed: null, active: null),
...
//                   child: InkWell(
//                     onTap: () => _addTodo(ref, _controller.text),
...
//           // Todo list
//          filteredTodos.isEmpty ? Text('') : Text('Click Todo to edit',style: TextStyle(fontSize: 18,fontWeight: FontWeight.w200),),
//           Expanded(
...
//                       return InkWell(
//                         onTap: (){
//                          // to edit todo take place here 
//                          Navigator.push(context, MaterialPageRoute(builder: (context)=> EditTodo(todo: todo)));
//                         },
